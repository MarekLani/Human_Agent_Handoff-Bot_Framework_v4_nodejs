...
const {
    ...
    const queueName = process.env.AGENT_REQUESTS_QUEUE;
    ...
    async function EnqueueMessage(message){
        ...
        const enqueueQueueResponse = await messagesURL.enqueue(Aborter.none, message);
        // console.log(
    ...
    async function DequeueMessage(){
        ...
        if (dequeueResponse.dequeuedMessageItems.length == 1) {
            ...
            message = dequeueMessageItem.messageText;
